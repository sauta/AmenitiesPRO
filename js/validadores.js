...
function revisarDigito2Encargado( crut )
{	
	largo = crut.length;	
	if ( largo < 2 )	
	{		
		alert("Debe ingresar el rut completo")		
		window.document.form1.txtRutEncargado.focus();		
		window.document.form1.txtRutEncargado.select();		
		return false;	
	}	
	if ( largo > 2 )		
...
function revisarDigito2Empresa( crut )
{	
	largo = crut.length;	
	if ( largo < 2 )	
	{		
...
{	
	...
	window.document.form1.txtRutEncargado.value = invertido.toUpperCase()		
...
{	
	...
	window.document.form1.txtRutEmpresa.value = invertido.toUpperCase()		
