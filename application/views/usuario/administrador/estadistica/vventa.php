  ...
  <form action="<?=site_url()?>/Factura/setUsuario" method="post">
    <div class="box-body">
     <div class="form-group">
              <select id="cboEmpresa2" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" name="cual_categoria" aria-hidden="true" required>
    ...
    <div class="box-header with-border">
      <h3 class="box-title">Estadistica de Ventas</h3>
    </div>
    <div class="box-body">
      <div class="row">
        <div class="col-md-8">          
